...
service Service1 {
    ...
    main{
        addToString( request )( response ) {
            response.msg = "S1: I've received your request " + request.msg
            println@Console("S1: I've received your request " + request.msg)()
        }
    }
}
...
service Service2 {
    ...
    init {
    	addToString@S4({msg = "S2"})(response)
    }
...
service Service3 {
    ...
    init {
    	addToString@S4IP({msg = "S3"})(response)
    }
